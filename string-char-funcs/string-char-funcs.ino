...
void loop() {
  ...
  // find a char in string and replace it with setCharAt()
  String reportString = "SensorReading: 456";
  Serial.println("Original: " + reportString);
  int colonPosition = reportString.indexOf(':');
  Serial.println("There is a colon at its position " + colonPosition);
  reportString.setCharAt(colonPosition, ' =');
  Serial.println("After replacing: " + reportString);
  Serial.println();

  // search char in a string with charAt()
